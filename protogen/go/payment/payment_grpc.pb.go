...
const (
	YourService_YourMethod_FullMethodName = "/payment.YourService/YourMethod"
)
...
func (c *yourServiceClient) YourMethod(ctx context.Context, in *PaymentRequest, opts ...grpc.CallOption) (YourService_YourMethodClient, error) {
	stream, err := c.cc.NewStream(ctx, &YourService_ServiceDesc.Streams[0], YourService_YourMethod_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
