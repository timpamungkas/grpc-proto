...
// 	protoc        v3.12.4
// source: proto/bank/type/balance.proto
...
func (x *CurrentBalanceRequest) Reset() {
	*x = CurrentBalanceRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_bank_type_balance_proto_msgTypes[0]
...
func (*CurrentBalanceRequest) Descriptor() ([]byte, []int) {
	return file_proto_bank_type_balance_proto_rawDescGZIP(), []int{0}
}
...
func (x *CurrentBalanceResponse) Reset() {
	*x = CurrentBalanceResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_bank_type_balance_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CurrentBalanceResponse) Descriptor() ([]byte, []int) {
	return file_proto_bank_type_balance_proto_rawDescGZIP(), []int{1}
}
...
var File_proto_bank_type_balance_proto protoreflect.FileDescriptor

var file_proto_bank_type_balance_proto_rawDesc = []byte{
	0x0a, 0x1d, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x62, 0x61, 0x6e, 0x6b, 0x2f, 0x74, 0x79, 0x70,
	0x65, 0x2f, 0x62, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12,
	...
	0x33, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x74, 0x69, 0x6d, 0x70,
	0x61, 0x6d, 0x75, 0x6e, 0x67, 0x6b, 0x61, 0x73, 0x2f, 0x67, 0x72, 0x70, 0x63, 0x2d, 0x70, 0x72,
...
var (
	file_proto_bank_type_balance_proto_rawDescOnce sync.Once
	file_proto_bank_type_balance_proto_rawDescData = file_proto_bank_type_balance_proto_rawDesc
)

func file_proto_bank_type_balance_proto_rawDescGZIP() []byte {
	file_proto_bank_type_balance_proto_rawDescOnce.Do(func() {
		file_proto_bank_type_balance_proto_rawDescData = protoimpl.X.CompressGZIP(file_proto_bank_type_balance_proto_rawDescData)
	})
	return file_proto_bank_type_balance_proto_rawDescData
}

var file_proto_bank_type_balance_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_proto_bank_type_balance_proto_goTypes = []interface{}{
...
var file_proto_bank_type_balance_proto_depIdxs = []int32{
...
func init() { file_proto_bank_type_balance_proto_init() }
func file_proto_bank_type_balance_proto_init() {
	if File_proto_bank_type_balance_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_proto_bank_type_balance_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_bank_type_balance_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_proto_bank_type_balance_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_proto_bank_type_balance_proto_goTypes,
		DependencyIndexes: file_proto_bank_type_balance_proto_depIdxs,
		MessageInfos:      file_proto_bank_type_balance_proto_msgTypes,
	}.Build()
	File_proto_bank_type_balance_proto = out.File
	file_proto_bank_type_balance_proto_rawDesc = nil
	file_proto_bank_type_balance_proto_goTypes = nil
	file_proto_bank_type_balance_proto_depIdxs = nil
}
