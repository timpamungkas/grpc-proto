...
const (
	ReliabilityService_UnaryReliability_FullMethodName           = "/reliability.ReliabilityService/UnaryReliability"
	ReliabilityService_ServerStreamingReliability_FullMethodName = "/reliability.ReliabilityService/ServerStreamingReliability"
	ReliabilityService_ClientStreamingReliability_FullMethodName = "/reliability.ReliabilityService/ClientStreamingReliability"
	ReliabilityService_BiDirectionalReliability_FullMethodName   = "/reliability.ReliabilityService/BiDirectionalReliability"
)
...
func (c *reliabilityServiceClient) UnaryReliability(ctx context.Context, in *ReliabilityRequest, opts ...grpc.CallOption) (*ReliabilityResponse, error) {
	...
	err := c.cc.Invoke(ctx, ReliabilityService_UnaryReliability_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *reliabilityServiceClient) ServerStreamingReliability(ctx context.Context, in *ReliabilityRequest, opts ...grpc.CallOption) (ReliabilityService_ServerStreamingReliabilityClient, error) {
	stream, err := c.cc.NewStream(ctx, &ReliabilityService_ServiceDesc.Streams[0], ReliabilityService_ServerStreamingReliability_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *reliabilityServiceClient) ClientStreamingReliability(ctx context.Context, opts ...grpc.CallOption) (ReliabilityService_ClientStreamingReliabilityClient, error) {
	stream, err := c.cc.NewStream(ctx, &ReliabilityService_ServiceDesc.Streams[1], ReliabilityService_ClientStreamingReliability_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *reliabilityServiceClient) BiDirectionalReliability(ctx context.Context, opts ...grpc.CallOption) (ReliabilityService_BiDirectionalReliabilityClient, error) {
	stream, err := c.cc.NewStream(ctx, &ReliabilityService_ServiceDesc.Streams[2], ReliabilityService_BiDirectionalReliability_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func _ReliabilityService_UnaryReliability_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ReliabilityService_UnaryReliability_FullMethodName,
	}
