...
var file_proto_hello_hello_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x67, 0x72, 0x65, 0x65, 0x74, 0x32, 0x8d, 0x03, 0x0a, 0x0c,
	...
	0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x3a, 0x0a, 0x0b, 0x53, 0x61, 0x79, 0x48, 0x65, 0x6c, 0x6c,
	0x6f, 0x54, 0x77, 0x6f, 0x12, 0x13, 0x2e, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x2e, 0x48, 0x65, 0x6c,
	...
	0x00, 0x12, 0x3c, 0x0a, 0x0d, 0x53, 0x61, 0x79, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x54, 0x68, 0x72,
	0x65, 0x65, 0x12, 0x13, 0x2e, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x2e, 0x48, 0x65, 0x6c, 0x6c, 0x6f,
	...
	0x3e, 0x0a, 0x0d, 0x53, 0x61, 0x79, 0x4d, 0x61, 0x6e, 0x79, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x73,
	...
	0x43, 0x0a, 0x12, 0x53, 0x61, 0x79, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x54, 0x6f, 0x45, 0x76, 0x65,
	0x72, 0x79, 0x6f, 0x6e, 0x65, 0x12, 0x13, 0x2e, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x2e, 0x48, 0x65,
	...
	0x22, 0x00, 0x28, 0x01, 0x12, 0x45, 0x0a, 0x12, 0x53, 0x61, 0x79, 0x48, 0x65, 0x6c, 0x6c, 0x6f,
	0x43, 0x6f, 0x6e, 0x74, 0x69, 0x6e, 0x75, 0x6f, 0x75, 0x73, 0x12, 0x13, 0x2e, 0x68, 0x65, 0x6c,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x28, 0x01, 0x30, 0x01, 0x42, 0x3d, 0x5a, 0x3b, 0x67,
	0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x74, 0x69, 0x6d, 0x70, 0x61, 0x6d,
	0x75, 0x6e, 0x67, 0x6b, 0x61, 0x73, 0x2f, 0x63, 0x6f, 0x75, 0x72, 0x73, 0x65, 0x2d, 0x67, 0x72,
...
var file_proto_hello_hello_proto_depIdxs = []int32{
	...
	0, // 1: hello.HelloService.SayHelloTwo:input_type -> hello.HelloRequest
	0, // 2: hello.HelloService.SayHelloThree:input_type -> hello.HelloRequest
	0, // 3: hello.HelloService.SayManyHellos:input_type -> hello.HelloRequest
	0, // 4: hello.HelloService.SayHelloToEveryone:input_type -> hello.HelloRequest
	0, // 5: hello.HelloService.SayHelloContinuous:input_type -> hello.HelloRequest
	1, // 6: hello.HelloService.SayHello:output_type -> hello.HelloResponse
	1, // 7: hello.HelloService.SayHelloTwo:output_type -> hello.HelloResponse
	1, // 8: hello.HelloService.SayHelloThree:output_type -> hello.HelloResponse
	1, // 9: hello.HelloService.SayManyHellos:output_type -> hello.HelloResponse
	1, // 10: hello.HelloService.SayHelloToEveryone:output_type -> hello.HelloResponse
	1, // 11: hello.HelloService.SayHelloContinuous:output_type -> hello.HelloResponse
